...
address = "https://lotusmarket.revelup.com/resources/OrderItem/?format=json&limit=50&updated_date__gte=" << time1.year.to_s << "-" << time1.month.to_s << "-" << time1.day.to_s << "&updated_date__lt=" << time2.year.to_s << "-" << time2.month.to_s << "-" << time2.day.to_s
